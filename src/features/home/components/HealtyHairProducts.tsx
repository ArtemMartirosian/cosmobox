...
import img from "@/assets/resources/Rectangle 390(1).svg";
import { HEALTY_HAIR_ITEMS } from "../constants/home.constants";

export const HealtyHairProducts = () => {
  return (
