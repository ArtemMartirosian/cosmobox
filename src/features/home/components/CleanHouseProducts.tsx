import img1 from "@/assets/resources/Rectangle 390 (1).svg";
import { ListItems } from "@/components/ListItems";
import { ProductCard } from "@/features/product/components/ProductCard";
import { ChevronRightIcon } from "@/icons/ChevronRightIcon";
import Image from "next/image";
import { CLEAN_HOUSE_ITEMS } from "../constants/home.constants";

export const CleanHouseProducts = () => {
  return (
    <div className=" w-full max-w-[1287px] mx-auto sm:mt-[48px] mt-[14px] flex flex-col 2xl:gap-[25px] gap-[20px] relative">
